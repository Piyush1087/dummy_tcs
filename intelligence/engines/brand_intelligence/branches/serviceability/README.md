# Brand Intelligence — Serviceability
...
Serviceability maintains Creator Shop's durable Brand-level understanding of where the Brand can currently and credibly provide its Offerings to customers.

## Location / business-state boundary

Primary Brand country/geography, canonical Locations, Location CRUD, Offering availability and Offering-to-Location relationships remain canonical application/business state. Serviceability may reference them but does not duplicate or own them.
...
One Serviceability schema applies across D2C, AI/SaaS, Healthcare and Offline Services. Industry changes serviceability reasoning, not topology. A globally accessible website never establishes global serviceability by itself.

## Topology status

Serviceability is one of the four permanently accepted Brand Intelligence branches for this architecture version alongside Brand Expression, Audience and Visual Identity.
