...
Layout System\
Application Shell\
Responsive Transformation System\
Content Resilience\
Components --- Actions\
Components --- Form Controls\
Components --- Selection & Status\
...
Components --- Identity & Media\
Reusable Patterns\
Component Selection Guidance\
Responsive Component Matrix\
Design Acceptance & Resilience Matrix\
Visual Reference\
AI / Design Tool Interpretation\
Change Governance
---
...
page/workflow identity;
section identity;
primary task/data;
supporting information;
metadata and helper information.
...
Semantics over resemblance. Choose components according to §20
before copying the apparent shape of a reference.
Reference screens demonstrate composition, not fixed content
geometry. Apply §8 to realistic data.
Responsive variants preserve the same product semantics. Apply
§7 rather than independently redesigning each breakpoint.
Feature contracts determine information priority. If
prioritization is consequential and unspecified, preserve
information or surface the unresolved product decision.
Use existing Aurora capability before proposing new Aurora
capability. Prefer component → pattern → feature composition →
Design System proposal.
Do not rewrite approved product copy to solve layout pressure.
Do not treat generated variation as a new token/component. A
...
stop using it in new work;
migrate existing work when justified;
remove it when compatibility permits.
25.7 Versioning
