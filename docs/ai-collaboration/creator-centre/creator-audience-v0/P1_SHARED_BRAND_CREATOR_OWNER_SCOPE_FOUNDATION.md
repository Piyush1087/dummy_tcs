...
- P1 backend: `175d4c150c12306ecd1577df10ebcc05b9035af6` /
...
- Migration base: 98 directories at P0; result: 100 directories.
...
- Clean disposable PostgreSQL 17 apply: 100/100, migration status current.
- Populated P0 upgrade: 98→100 PASS. Resource count/hash remained
...
- PostgreSQL tests prove first-class Creator insert/read/purge, nullable Brand
  ...
  cross-Brand substitution rejection and canonical Creator scope retention.
...
One bounded correction cycle was used to split enum creation from enum-value
use and correct UUID/text handling in the task-only migration rehearsal. The
published migrations are the clean, proven form; no history rewrite occurred.
