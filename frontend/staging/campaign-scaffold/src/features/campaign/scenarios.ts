...
export function applyScenario(base: CampaignPageView, scenario: ScenarioId): CampaignPageView {
  ...
  if (scenario === "readiness-blocked") return { ...base,hydration:{outcome:"POST_LIVE_READINESS_BLOCK",executionReady:false,primaryFocus:"RESTORE_CAMPAIGN_READINESS",postLiveReadinessBlocked:true},share:{...base.share,capability:disabled} };
