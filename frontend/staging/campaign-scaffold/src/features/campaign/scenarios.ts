...
export const scenarioIds = ["live-discovery", "draft", "product-setup", "brief-setup", "creator-acquisition", "applications-active", "paused", "completed", "archived", "loading", "no-results", "unavailable"] as const;
