...
- `reference-registry.md` maps every imported artifact to the Campaign state or surface it represents and records the Stitch source screen plus original screenshot URL.
